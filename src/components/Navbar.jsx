    ...
    <nav className="bg-theme-primary border-b border-theme sticky top-0 z-50" style={{ transition: 'background-color 0.3s ease' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <button onClick={() => scrollToSection('home')} className="flex items-center space-x-2 sm:space-x-3">
            <img src="/img/logo.png" alt="Logo" className="h-8 sm:h-10 w-auto" />
            <span className="text-base sm:text-xl font-bold text-theme-text">
              <span className="hidden xs:inline">Portfolio <span className="text-coral">|</span> </span>
              <span className="text-coral">Towsif</span>
            </span>
          </button>

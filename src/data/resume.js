export const resume = {
  ...
  education: [
    {
      ...
      achievements: [
        ...
        "Active member of programming club and tech communities",
    ...
    },
    {
      ...
      gpa: "5.00/5.00",
      achievements: [
        "GPA: 5.00 with scholarship",
        "Excellent performance in Science group",
      ],
    },
    {
      id: 3,
  ...
  skills: {
    technical: [
      ...
      "React, Flutter, HTML5, CSS3, Tailwind CSS",
      "Firebase, MongoDB, MySQL, MSSQL",
      "Data Analytics, Power BI, Data Visualization",
      "Prompt Engineering, AI/ML Fundamentals",
  ...
  pdfUrl: "/resume.pdf", // Place your resume PDF in the public folder
};
